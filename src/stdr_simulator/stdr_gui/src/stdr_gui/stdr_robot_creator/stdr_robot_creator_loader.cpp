...
void CRobotCreatorLoader::setupInitialTree(void) {
  addIcon.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/add_icon.png"))
                            .c_str()),
      QSize(16, 16), QIcon::Normal, QIcon::Off);
  editIcon.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/edit_icon.png"))
                            .c_str()),
      QSize(16, 16), QIcon::Normal, QIcon::Off);
  removeIcon.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
  ...
  saveIcon.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/save_icon.png"))
                            .c_str()),
      QSize(16, 16), QIcon::Normal, QIcon::Off);
  loadIcon.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/load_icon.png"))
                            .c_str()),
      QSize(16, 16), QIcon::Normal, QIcon::Off);
