...
@return void
**/
CGuiLoader::CGuiLoader(int argc, char **argv) : argc_(argc), argv_(argv) {
  setupUi(this);
...
void CGuiLoader::addToolbarIcons(void) {
  ...
  applicationIcon.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/favicon.ico"))
                            .c_str()),
  ...
  iconLoadMap.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/load_map.png"))
                            .c_str()),
      QSize(), QIcon::Normal, QIcon::Off);
  ...
  QIcon iconAddRobot;
  iconAddRobot.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/add_robot.png"))
                            .c_str()),
      QSize(), QIcon::Normal, QIcon::Off);
  ...
  QIcon iconNewRobot;
  iconNewRobot.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/new_robot.png"))
                            .c_str()),
      QSize(), QIcon::Normal, QIcon::Off);
  ...
  iconNewRfid.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/rfid.png"))
                            .c_str()),
      QSize(), QIcon::Normal, QIcon::Off);
  ...
  iconNewThermal.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/thermal.png"))
                            .c_str()),
      QSize(), QIcon::Normal, QIcon::Off);
  ...
  iconNewCo2.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/co2.png"))
                            .c_str()),
      QSize(), QIcon::Normal, QIcon::Off);
  ...
  QIcon iconNewSound;
  iconNewSound.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/sound.png"))
                            .c_str()),
      QSize(), QIcon::Normal, QIcon::Off);
  ...
  iconProperties.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/properties.png"))
                            .c_str()),
      QSize(), QIcon::Normal, QIcon::Off);
  ...
  iconGrid.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/grid.png"))
                            .c_str()),
      QSize(), QIcon::Normal, QIcon::Off);
  ...
  iconZoomIn.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/zoom_in_b.png"))
                            .c_str()),
      QSize(), QIcon::Normal, QIcon::Off);
  ...
  iconZoomOut.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/zoom_out_b.png"))
                            .c_str()),
      QSize(), QIcon::Normal, QIcon::Off);
  ...
  iconAdjust.addFile(
      QString::fromUtf8((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                         std::string("/resources/images/adjusted.png"))
                            .c_str()),
      QSize(), QIcon::Normal, QIcon::Off);
...
@return QEvent*
**/
QEvent *CGuiLoader::getCloseEvent(void) { return event_; }

/**
@brief Returns true if a close event was triggered
@return bool
**/
bool CGuiLoader::closeTriggered(void) { return close_signal_; }

/**
@brief Shuts down the main window
@return void
**/
void CGuiLoader::shutdown(void) { this->close(); }
}  // namespace stdr_gui
