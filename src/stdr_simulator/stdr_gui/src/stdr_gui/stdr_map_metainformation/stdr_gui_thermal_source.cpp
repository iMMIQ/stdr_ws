...
CGuiThermalSource::CGuiThermalSource(QPoint p, std::string name,
                                     float resolution)
    : CGuiSource(p, name, resolution), degrees_(0.0) {}
...
@return void
**/
void CGuiThermalSource::setDegrees(float degrees) { degrees_ = degrees; }

/**
@brief Returns the tag message
@return QString
**/
float CGuiThermalSource::getDegrees(void) { return degrees_; }
}  // namespace stdr_gui
