...
**/
float angleRadToDegrees(float angle) { return angle * 180.0 / STDR_PI; }
...
**/
float angleDegreesToRad(float angle) { return angle / 180.0 * STDR_PI; }
...
stdr_msgs::RobotMsg fixRobotAnglesToRad(stdr_msgs::RobotMsg rmsg) {
  rmsg.initialPose.theta = rmsg.initialPose.theta / 180.0 * STDR_PI;
...
**/
stdr_msgs::ThermalSensorMsg fixThermalAnglesToRad(
