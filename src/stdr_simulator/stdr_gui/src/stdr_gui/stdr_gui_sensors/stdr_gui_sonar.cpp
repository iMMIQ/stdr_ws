...
@return void
**/
void CGuiSonar::paint(QImage *m, float ocgd, tf::TransformListener *listener) {
  lock_ = true;
  QPainter painter(m);
  ...
  painter.drawPie(pose_x / ocgd - real_dist / ocgd,

                  pose_y / ocgd - real_dist / ocgd,

                  real_dist / ocgd * 2, real_dist / ocgd * 2,
...
@return void
**/
void CGuiSonar::visualizerPaint(QImage *m, float ocgd, float maxRange) {
  float size = m->width();
  ...
  painter.drawPie(
      ...
      real_dist / ocgd * 2 * climax, real_dist / ocgd * 2 * climax,
...
@return float
**/
float CGuiSonar::getMaxRange(void) { return msg_.maxRange; }

/**
@brief Returns the visibility status of the specific sonar sensor
@return char : The visibility status
**/
char CGuiSonar::getVisualizationStatus(void) { return visualization_status_; }
...
**/
std::string CGuiSonar::getFrameId(void) { return msg_.frame_id; }
...
@return void
**/
void CGuiSonar::setVisualizationStatus(char vs) { visualization_status_ = vs; }
}  // namespace stdr_gui
