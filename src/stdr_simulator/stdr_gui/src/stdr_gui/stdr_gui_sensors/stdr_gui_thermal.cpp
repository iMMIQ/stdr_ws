...
**/
void CGuiThermal::paint(QImage *m, float ocgd,
...
**/
char CGuiThermal::getVisualizationStatus(void) { return visualization_status_; }
...
**/
std::string CGuiThermal::getFrameId(void) { return msg_.frame_id; }
