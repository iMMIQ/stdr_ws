...
**/
void CGuiRfid::paint(QImage *m, float ocgd, tf::TransformListener *listener) {
  lock_ = true;
  QPainter painter(m);
...
**/
char CGuiRfid::getVisualizationStatus(void) { return visualization_status_; }
...
**/
void CGuiRfid::setVisualizationStatus(char vs) { visualization_status_ = vs; }

/**
@brief Returns the frame id of the specific sensor
@return std::string : The sensor's frame id
**/
std::string CGuiRfid::getFrameId(void) { return msg_.frame_id; }
