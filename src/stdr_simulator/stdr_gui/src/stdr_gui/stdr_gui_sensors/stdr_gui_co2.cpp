...
**/
void CGuiCO2::paint(QImage *m, float ocgd, tf::TransformListener *listener) {
  lock_ = true;
  QPainter painter(m);
...
**/
char CGuiCO2::getVisualizationStatus(void) { return visualization_status_; }
...
**/
void CGuiCO2::setVisualizationStatus(char vs) { visualization_status_ = vs; }

/**
@brief Returns the frame id of the specific sensor
@return std::string : The sensor's frame id
**/
std::string CGuiCO2::getFrameId(void) { return msg_.frame_id; }
