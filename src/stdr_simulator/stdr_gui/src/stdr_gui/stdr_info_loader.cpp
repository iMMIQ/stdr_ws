...
@return void
**/
CInfoLoader::CInfoLoader(int argc, char **argv) : argc_(argc), argv_(argv) {
  setupUi(this);
  ...
  visible_icon_.addFile(QString((stdr_gui_tools::getRosPackagePath("stdr_gui") +
                                 std::string("/resources/images/visible.png"))
                                    .c_str()));

  visible_icon_on_.addFile(
      QString((stdr_gui_tools::getRosPackagePath("stdr_gui") +
               std::string("/resources/images/visible_on.png"))
                  .c_str()));
  visible_icon_off_.addFile(
      QString((stdr_gui_tools::getRosPackagePath("stdr_gui") +
               std::string("/resources/images/visible_off.png"))
                  .c_str()));
  visible_icon_trans_.addFile(
      QString((stdr_gui_tools::getRosPackagePath("stdr_gui") +
               std::string("/resources/images/visible_transparent.png"))
                  .c_str()));
}
...
void CInfoLoader::updateRobots(const stdr_msgs::RobotIndexedVectorMsg &msg) {
  for (unsigned int i = 0; i < msg.robots.size(); i++) {
    ...
    radius->setText(1, (QString().setNum(msg.robots[i].robot.footprint.radius) +
                        QString("m")));
    ...
    kinematics->setText(
        1, QString(msg.robots[i].robot.kinematicModel.type.c_str()));
    ...
    for (unsigned int l = 0; l < msg.robots[i].robot.laserSensors.size(); l++) {
      ...
      lrays->setText(
          1, QString().setNum(msg.robots[i].robot.laserSensors[l].numRays));
      lmaxrange->setText(0, "Max dist");
      lmaxrange->setText(
          1, (QString().setNum(msg.robots[i].robot.laserSensors[l].maxRange) +
              QString(" m")));
      lminrange->setText(0, "Min dist");
      lminrange->setText(
          1, (QString().setNum(msg.robots[i].robot.laserSensors[l].minRange) +
              QString(" m")));
      lmaxangle->setText(0, "Max angle");
      lmaxangle->setText(
          1, (QString().setNum(msg.robots[i].robot.laserSensors[l].maxAngle) +
              QString(" rad")));
      lminangle->setText(0, "Min angle");
      lminangle->setText(
          1, (QString().setNum(msg.robots[i].robot.laserSensors[l].minAngle) +
              QString(" rad")));
      ...
      lfreq->setText(
          1, (QString().setNum(msg.robots[i].robot.laserSensors[l].frequency) +
              QString(" Hz")));

      lposex->setText(0, "x pose");
      lposex->setText(
          1, (QString().setNum(msg.robots[i].robot.laserSensors[l].pose.x) +
              QString(" m")));
      lposey->setText(0, "y pose");
      lposey->setText(
          1, (QString().setNum(msg.robots[i].robot.laserSensors[l].pose.y) +
              QString(" m")));
      lorientation->setText(0, "Orientation");
      lorientation->setText(
          1, (QString().setNum(msg.robots[i].robot.laserSensors[l].pose.theta) +
              QString(" rad")));
    ...
    for (unsigned int l = 0; l < msg.robots[i].robot.sonarSensors.size(); l++) {
      ...
      smaxrange->setText(
          1, (QString().setNum(msg.robots[i].robot.sonarSensors[l].maxRange) +
              QString(" m")));
      sminrange->setText(0, "Min dist");
      sminrange->setText(
          1, (QString().setNum(msg.robots[i].robot.sonarSensors[l].minRange) +
              QString(" m")));
      scone->setText(0, "Cone");
      scone->setText(
          1, (QString().setNum(msg.robots[i].robot.sonarSensors[l].coneAngle) +
              QString(" rad")));
      sorientation->setText(0, "Orientation");
      sorientation->setText(
          1, (QString().setNum(msg.robots[i].robot.sonarSensors[l].pose.theta) +
              QString(" rad")));
      ...
      sfreq->setText(
          1, (QString().setNum(msg.robots[i].robot.sonarSensors[l].frequency) +
              QString(" Hz")));

      sposex->setText(0, "x pose");
      sposex->setText(
          1, (QString().setNum(msg.robots[i].robot.sonarSensors[l].pose.x) +
              QString(" m")));
      sposey->setText(0, "y pose");
      sposey->setText(
          1, (QString().setNum(msg.robots[i].robot.sonarSensors[l].pose.y) +
              QString(" m")));
    ...
    for (unsigned int l = 0; l < msg.robots[i].robot.rfidSensors.size(); l++) {
      QTreeWidgetItem *sname;
      sname = new QTreeWidgetItem();
      sname->setText(0, msg.robots[i].robot.rfidSensors[l].frame_id.c_str());
      sname->setIcon(2, visible_icon_on_);
      //~ sname->setIcon(3,visible_icon_);
      ...
      smaxrange->setText(0, "Max dist");
      smaxrange->setText(
          1, (QString().setNum(msg.robots[i].robot.rfidSensors[l].maxRange) +
              QString(" m")));

      sspan->setText(0, "Angle span");
      sspan->setText(
          1, (QString().setNum(msg.robots[i].robot.rfidSensors[l].angleSpan) +
              QString(" rad")));

      sorientation->setText(0, "Orientation");
      sorientation->setText(
          1, (QString().setNum(msg.robots[i].robot.rfidSensors[l].pose.theta) +
              QString(" rad")));

      scutoff->setText(0, "Signal Cutoff");
      scutoff->setText(
          1,
          (QString().setNum(msg.robots[i].robot.rfidSensors[l].signalCutoff) +
           QString("")));

      sfreq->setText(0, "Frequency");
      sfreq->setText(
          1, (QString().setNum(msg.robots[i].robot.rfidSensors[l].frequency) +
              QString(" Hz")));

      sposex->setText(0, "x pose");
      sposex->setText(
          1, (QString().setNum(msg.robots[i].robot.rfidSensors[l].pose.x) +
              QString(" m")));

      sposey->setText(0, "y pose");
      sposey->setText(
          1, (QString().setNum(msg.robots[i].robot.rfidSensors[l].pose.y) +
              QString(" m")));
    ...
    for (unsigned int l = 0; l < msg.robots[i].robot.co2Sensors.size(); l++) {
      QTreeWidgetItem *sname;
      sname = new QTreeWidgetItem();
      sname->setText(0, msg.robots[i].robot.co2Sensors[l].frame_id.c_str());
      sname->setIcon(2, visible_icon_on_);
      //~ sname->setIcon(3,visible_icon_);
      ...
      smaxrange->setText(0, "Max dist");
      smaxrange->setText(
          1, (QString().setNum(msg.robots[i].robot.co2Sensors[l].maxRange) +
              QString(" m")));
      ...
      sorientation->setText(0, "Orientation");
      sorientation->setText(
          1, (QString().setNum(msg.robots[i].robot.co2Sensors[l].pose.theta) +
              QString(" rad")));
      ...
      sfreq->setText(0, "Frequency");
      sfreq->setText(
          1, (QString().setNum(msg.robots[i].robot.co2Sensors[l].frequency) +
              QString(" Hz")));

      sposex->setText(0, "x pose");
      sposex->setText(
          1, (QString().setNum(msg.robots[i].robot.co2Sensors[l].pose.x) +
              QString(" m")));

      sposey->setText(0, "y pose");
      sposey->setText(
          1, (QString().setNum(msg.robots[i].robot.co2Sensors[l].pose.y) +
              QString(" m")));
    ...
    for (unsigned int l = 0; l < msg.robots[i].robot.thermalSensors.size();
      ...
      QTreeWidgetItem *sname;
      sname = new QTreeWidgetItem();
      sname->setText(0, msg.robots[i].robot.thermalSensors[l].frame_id.c_str());
      sname->setIcon(2, visible_icon_on_);
      //~ sname->setIcon(3,visible_icon_);
      ...
      smaxrange->setText(0, "Max dist");
      smaxrange->setText(
          1, (QString().setNum(msg.robots[i].robot.thermalSensors[l].maxRange) +
              QString(" m")));

      sspan->setText(0, "Angle span");
      sspan->setText(
          1,
          (QString().setNum(msg.robots[i].robot.thermalSensors[l].angleSpan) +
           QString(" rad")));

      sorientation->setText(0, "Orientation");
      sorientation->setText(
          1,
          (QString().setNum(msg.robots[i].robot.thermalSensors[l].pose.theta) +
           QString(" rad")));
      ...
      sfreq->setText(
          1,
          (QString().setNum(msg.robots[i].robot.thermalSensors[l].frequency) +
           QString(" Hz")));

      sposex->setText(0, "x pose");
      sposex->setText(
          1, (QString().setNum(msg.robots[i].robot.thermalSensors[l].pose.x) +
              QString(" m")));

      sposey->setText(0, "y pose");
      sposey->setText(
          1, (QString().setNum(msg.robots[i].robot.thermalSensors[l].pose.y) +
              QString(" m")));
    ...
    for (unsigned int l = 0; l < msg.robots[i].robot.soundSensors.size(); l++) {
      QTreeWidgetItem *sname;
      sname = new QTreeWidgetItem();
      sname->setText(0, msg.robots[i].robot.soundSensors[l].frame_id.c_str());
      sname->setIcon(2, visible_icon_on_);
      //~ sname->setIcon(3,visible_icon_);
      ...
      smaxrange->setText(0, "Max dist");
      smaxrange->setText(
          1, (QString().setNum(msg.robots[i].robot.soundSensors[l].maxRange) +
              QString(" m")));

      sspan->setText(0, "Angle span");
      sspan->setText(
          1, (QString().setNum(msg.robots[i].robot.soundSensors[l].angleSpan) +
              QString(" rad")));

      sorientation->setText(0, "Orientation");
      sorientation->setText(
          1, (QString().setNum(msg.robots[i].robot.soundSensors[l].pose.theta) +
              QString(" rad")));
      ...
      sfreq->setText(0, "Frequency");
      sfreq->setText(
          1, (QString().setNum(msg.robots[i].robot.soundSensors[l].frequency) +
              QString(" Hz")));

      sposex->setText(0, "x pose");
      sposex->setText(
          1, (QString().setNum(msg.robots[i].robot.soundSensors[l].pose.x) +
              QString(" m")));

      sposey->setText(0, "y pose");
      sposey->setText(
          1, (QString().setNum(msg.robots[i].robot.soundSensors[l].pose.y) +
              QString(" m")));
