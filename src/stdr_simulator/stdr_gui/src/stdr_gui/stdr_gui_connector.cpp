...
CGuiConnector::CGuiConnector(int argc, char **argv)
  ...
  QObject::connect(loader_.actionProperties, SIGNAL(triggered(bool)), this,
                   SLOT(actionPropertiesTriggered()));

  QObject::connect(loader_.actionAbout_STDR_Simulator, SIGNAL(triggered(bool)),
                   this, SLOT(actionAboutTriggered()));

  QObject::connect(loader_.actionExit, SIGNAL(triggered(bool)), this,
                   SLOT(actionExitTriggered()));

  QObject::connect(loader_.actionLoadMap, SIGNAL(triggered(bool)), this,
                   SLOT(actionLoadMapTriggered()));

  QObject::connect(loader_.actionNewRobot, SIGNAL(triggered(bool)), this,
                   SLOT(actionNewRobotTriggered()));

  QObject::connect(loader_.actionAddRobot, SIGNAL(triggered(bool)), this,
                   SLOT(actionAddRobotTriggered()));

  QObject::connect(loader_.actionZoomIn, SIGNAL(triggered(bool)), this,
                   SLOT(actionZoomInTriggered()));

  QObject::connect(loader_.actionZoomOut, SIGNAL(triggered(bool)), this,
                   SLOT(actionZoomOutTriggered()));

  QObject::connect(loader_.actionAdjusted, SIGNAL(triggered(bool)), this,
                   SLOT(actionAdjustedTriggered()));

  QObject::connect(loader_.actionGrid, SIGNAL(triggered(bool)), this,
                   SLOT(actionGridTriggered()));

  QObject::connect(loader_.actionNewRfid, SIGNAL(triggered(bool)), this,
                   SLOT(actionNewRfidTriggered()));

  QObject::connect(loader_.actionNewThermal, SIGNAL(triggered(bool)), this,
                   SLOT(actionNewThermalTriggered()));

  QObject::connect(loader_.actionNewCo2, SIGNAL(triggered(bool)), this,
                   SLOT(actionNewCo2Triggered()));

  QObject::connect(loader_.actionNewSound, SIGNAL(triggered(bool)), this,
                   SLOT(actionNewSoundTriggered()));
...
void CGuiConnector::actionLoadMapTriggered(void) {
  ...
  while (!ros::service::waitForService("/stdr_server/load_static_map_external",
                                       ros::Duration(.1)) &&
         ros::ok()) {
...
void CGuiConnector::actionAboutTriggered(void) {
  ...
  msg.setText(
      QString("Simple Two Dimentional Robot Simulator\
...
/**
@brief Qt slot that is called when the adjusted map visualization tool button is
pressed
@return void
**/
...
**/
bool CGuiConnector::isGridEnabled(void) { return grid_enabled_; }
...
**/
QEvent *CGuiConnector::getCloseEvent(void) { return loader_.getCloseEvent(); }

/**
@brief Returns the exit triggered status
@return bool True if exit has been triggered
**/
bool CGuiConnector::closeTriggered(void) { return loader_.closeTriggered(); }

/**
@brief Shuts down the main window
@return void
**/
void CGuiConnector::shutdown(void) { loader_.shutdown(); }
...
@return void
**/
void CGuiConnector::setMapInitialized(bool mi) { map_initialized_ = mi; }
