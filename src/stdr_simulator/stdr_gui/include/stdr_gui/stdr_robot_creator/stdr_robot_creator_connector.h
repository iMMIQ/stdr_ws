...
@brief Implements the high level functionalities of the robot creator widget.
Inherits form QObject
**/
class CRobotCreatorConnector : public QObject {
  Q_OBJECT
  //------------------------------------------------------------------------//
 private:
  ...
  //!< Variable that holds the proportion coefficient for the visualization of
  //!< robot creator image
  float climax_;
  ...
  **/
  ...
  void updateThermalSensorTree(QTreeWidgetItem *item,
                               stdr_msgs::ThermalSensorMsg l);
  void updateSoundSensorTree(QTreeWidgetItem *item,
  ...
  **/
  ...
  /**
  @brief Edits a specific rfid antenna sensor based on a tree item. Initiates
  the rfid antenna sensor editor widget
  @param item [QTreeWidgetItem*] Tree item that holds the specific rfid antenna
  sensor
  @return void
  **/
  ...
  @param item [QTreeWidgetItem*] Tree item that holds the specific footprint
  point
  @return void
  **/
