...
@brief Implements the functionalities of the robot visualization widget.
Inherits form QWidget and Ui_robotVisualization (auto created from ui file)
**/
class CRobotVisualisation : public QWidget, public Ui_robotVisualization {
  //------------------------------------------------------------------------//
 private:
