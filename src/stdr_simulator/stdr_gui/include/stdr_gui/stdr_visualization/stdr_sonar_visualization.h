...
@brief Implements the functionalities of the sonar visualization widget.
Inherits form QWidget and Ui_sonarVisualization (auto created from ui file)
**/
class CSonarVisualisation : public QWidget, public Ui_sonarVisualization {
  //------------------------------------------------------------------------//
 private:
