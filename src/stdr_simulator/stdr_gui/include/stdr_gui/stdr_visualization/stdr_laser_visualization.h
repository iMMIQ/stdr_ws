...
@brief Implements the functionalities of the laser visualization widget.
Inherits form QWidget and Ui_laserVisualization (auto created from ui file)
**/
class CLaserVisualisation : public QWidget, public Ui_laserVisualization {
  //------------------------------------------------------------------------//
 private:
