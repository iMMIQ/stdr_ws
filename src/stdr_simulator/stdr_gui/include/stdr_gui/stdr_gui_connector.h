...
**/
class CGuiConnector : public QObject {
  Q_OBJECT
  ...
  **/
  ...
  /**
  @brief Qt slot that is called when the adjusted map visualization tool button
  is pressed
  @return void
  **/
 ...
 Q_SIGNALS:
  ...
  /**
  @brief Qt signal that is emmited in GuiConnector::actionZoomInTriggered and
  connects to MapLoader::setCursorZoomIn
  ...
  **/
  ...
  /**
  @brief Qt signal that is emmited in GuiConnector::actionZoomOutTriggered and
  connects to MapLoader::setCursorZoomOut
  @param state [bool] Toggle flag
  @return void
  **/
