...
/**
@class CInfoLoader
@brief Implements the low level Qt functionalities of the information tree.
Inherits from Ui_information (generated from an ui file) and QWidget.
**/
class CInfoLoader : public QWidget, public Ui_information {
  //------------------------------------------------------------------------//
 private:
