...
**/
class CGuiController : public QThread {
  Q_OBJECT
  ...
  **/
  stdr_msgs::LaserSensorMsg getLaserDescription(QString robotName,
                                                QString laserName);
  ...
  **/
  stdr_msgs::SonarSensorMsg getSonarDescription(QString robotName,
                                                QString sonarName);
  ...
  **/
  ...
  /**
  @brief Receives the occupancy grid map from stdr_server. Connects to "map" ROS
  topic
 ...
 public Q_SLOTS:
  ...
  /**
  @brief Saves the robot in a yaml file. Connects to the
  ...
  **/
  ...
  /**
  @brief Informs CGuiController that a robot is loaded from a yaml file.
  Connects to the CGuiConnector::robotFromFile signal
  @param newRobotMsg [stdr_msgs::RobotMsg] The robot to be put in the map
  @return void
  **/
  ...
  **/
  ...
  /**
  @brief Informs CGuiController that a thermal source is going to be placed in
  the environment. Connects to the CGuiConnector::loadThermalPressed signal
  @return void
  **/
  ...
  **/
  ...
  /**
  @brief Gets the point at which the new RFID tag is placed. Connects to the
  CMapConnector::robotPlaceSet signal
  @param p [QPoint] The event point in the OGM
  @return void
  **/
  ...
  **/
  ...
  /**
  @brief Informs CGuiController that a laser visualizer has been clicked.
  Connects to the CInfoConnector::laserVisualizerClicked signal
  @param robotName [QString] Frame id of the robot
  @param laserName [QString] Frame id of the laser
  @return void
  **/
  ...
  /**
  @brief Informs CGuiController that a sonar visualizer has been clicked.
  Connects to the CInfoConnector::sonarVisualizerClicked signal
  @param robotName [QString] Frame id of the robot
  @param sonarName [QString] Frame id of the sonar
  @return void
  **/
  ...
  /**
  @brief Informs CGuiController that a robot visualizer has been clicked.
  Connects to the CInfoConnector::robotVisualizerClicked signal
  @param robotName [QString] Frame id of the robot
  @return void
  **/
  ...
  **/
  ...
  @return void
  **/
  void thermalSensorVisibilityClicked(QString robotName,
 ...
 Q_SIGNALS:
  ...
  /**
  @brief Is emitted when a new robot is going to be placed. Connects to the
  CMapConnector::waitForPlace slot
  @return void
  **/
  void waitForRobotPose(void);

  /**
  @brief Is emitted when a new thermal source is going to be placed. Connects to
  the CMapConnector::waitForThermalPose slot
  @return void
  **/
  void waitForThermalPose(void);

  /**
  @brief Is emitted when a new CO2 source is going to be placed. Connects to the
  CMapConnector::waitForCo2Pose slot
  @return void
  **/
  void waitForCo2Pose(void);

  /**
  @brief Is emitted when a new sound source is going to be placed. Connects to
  the CMapConnector::waitForSOundPose slot
  @return void
  **/
  void waitForSoundPose(void);

  /**
  @brief Is emitted when a new rfid tag is going to be placed. Connects to the
  CMapConnector::waitForRfidPose slot
  @return void
  **/
  void waitForRfidPose(void);

  /**
  @brief Is emitted when a robot is going to be re-placed. Connects to the
  CMapConnector::waitForReplace slot
  ...
  **/
  ...
  /**
  @brief Is emitted when a laser's visibility status is going to be changed.
  Connects to the CInfoConnector::setLaserVisibility slot
  @param robotName [QString] The frame id of the robot containing the specific
  laser
  ...
  **/
  ...
  /**
  @brief Is emitted when a sonar's visibility status is going to be changed.
  Connects to the CInfoConnector::setSonarVisibility slot
  @param robotName [QString] The frame id of the robot containing the specific
  sonar
  ...
  **/
  ...
  @return void
  **/
  void setRfidReaderVisibility(QString robotName, QString rfidReaderName,
                               char vs);
  ...
  @return void
  **/
  void setCO2SensorVisibility(QString robotName, QString co2SensorName,
                              char vs);
  ...
  @return void
  **/
  void setThermalSensorVisibility(QString robotName, QString thermalSensorName,
                                  char vs);
  ...
  @return void
  **/
  void setSoundSensorVisibility(QString robotName, QString soundSensorName,
                                char vs);

  /**
  @brief Is emitted when a robot's visibility status is going to be changed.
  Connects to the CInfoConnector::setRobotVisibility slot
