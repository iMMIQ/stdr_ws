...
class MotionController {
  ...
  **/
  inline geometry_msgs::Pose2D getPose(void) { return _pose; }
  ...
  */
  inline geometry_msgs::Twist getVelocity() { return _currentTwist; }
 ...
 protected:
  ...
  @return void
  **/
  MotionController(const geometry_msgs::Pose2D& pose,
                   tf::TransformBroadcaster& tf, const std::string& name,
    ...
    _velocitySubscrider = n.subscribe(
        _namespace + "/cmd_vel", 1, &MotionController::velocityCallback, this);
