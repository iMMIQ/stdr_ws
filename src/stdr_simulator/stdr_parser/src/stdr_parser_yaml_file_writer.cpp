...
template void YamlFileWriter::messageToFile(stdr_msgs::Noise msg,
                                            std::string file_name);

//!< Template specialization for stdr_msgs::Noise
template <>
YAML::Emitter& operator<<<stdr_msgs::Noise>(YAML::Emitter& out,
...
template void YamlFileWriter::messageToFile(stdr_msgs::FootprintMsg msg,
                                            std::string file_name);
...
template void YamlFileWriter::messageToFile(geometry_msgs::Pose2D msg,
                                            std::string file_name);
...
template void YamlFileWriter::messageToFile(stdr_msgs::KinematicMsg msg,
                                            std::string file_name);
...
template void YamlFileWriter::messageToFile(stdr_msgs::LaserSensorMsg msg,
                                            std::string file_name);
...
template void YamlFileWriter::messageToFile(stdr_msgs::SonarSensorMsg msg,
                                            std::string file_name);
...
template void YamlFileWriter::messageToFile(stdr_msgs::RfidSensorMsg msg,
                                            std::string file_name);
...
template void YamlFileWriter::messageToFile(stdr_msgs::CO2SensorMsg msg,
                                            std::string file_name);
...
template void YamlFileWriter::messageToFile(stdr_msgs::ThermalSensorMsg msg,
                                            std::string file_name);
...
template void YamlFileWriter::messageToFile(stdr_msgs::SoundSensorMsg msg,
                                            std::string file_name);
...
template void YamlFileWriter::messageToFile(stdr_msgs::RobotMsg msg,
                                            std::string file_name);

//!< Template specialization for stdr_msgs::RobotMsg
template <>
YAML::Emitter& operator<<<stdr_msgs::RobotMsg>(YAML::Emitter& out,
