...
template void XmlFileWriter::messageToFile(stdr_msgs::Noise msg,
                                           std::string file_name);

//!< Template specialization for stdr_msgs::Noise
template <>
void XmlFileWriter::messageToXmlElement<stdr_msgs::Noise>(stdr_msgs::Noise msg,
                                                          TiXmlNode* base) {
  //!< Create noise
  TiXmlElement* noise;
...
template void XmlFileWriter::messageToFile(stdr_msgs::FootprintMsg msg,
                                           std::string file_name);
...
template void XmlFileWriter::messageToFile(stdr_msgs::LaserSensorMsg msg,
                                           std::string file_name);
...
void XmlFileWriter::messageToXmlElement<stdr_msgs::LaserSensorMsg>(
  ...
  TiXmlElement* laser_specifications = new TiXmlElement("laser_specifications");
...
template void XmlFileWriter::messageToFile(stdr_msgs::SonarSensorMsg msg,
                                           std::string file_name);
...
void XmlFileWriter::messageToXmlElement<stdr_msgs::SonarSensorMsg>(
  ...
  TiXmlElement* sonar_specifications = new TiXmlElement("sonar_specifications");
...
template void XmlFileWriter::messageToFile(stdr_msgs::RfidSensorMsg msg,
                                           std::string file_name);
...
template void XmlFileWriter::messageToFile(stdr_msgs::CO2SensorMsg msg,
                                           std::string file_name);
...
template void XmlFileWriter::messageToFile(stdr_msgs::ThermalSensorMsg msg,
                                           std::string file_name);
...
template void XmlFileWriter::messageToFile(stdr_msgs::SoundSensorMsg msg,
                                           std::string file_name);
...
template void XmlFileWriter::messageToFile(stdr_msgs::KinematicMsg msg,
                                           std::string file_name);
...
template void XmlFileWriter::messageToFile(stdr_msgs::RobotMsg msg,
                                           std::string file_name);
...
void XmlFileWriter::messageToXmlElement<stdr_msgs::RobotMsg>(
  ...
  TiXmlElement* robot_specifications = new TiXmlElement("robot_specifications");
