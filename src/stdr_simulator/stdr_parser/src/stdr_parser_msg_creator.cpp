...
**/
template <>
geometry_msgs::Pose2D MessageCreator::createMessage(Node *n, unsigned int id) {
...
**/
template <>
stdr_msgs::Noise MessageCreator::createMessage(Node *n, unsigned int id) {
  stdr_msgs::Noise msg;
...
**/
template <>
stdr_msgs::FootprintMsg MessageCreator::createMessage(Node *n,
                                                      unsigned int id) {
  ...
  if (indexes.size() != 0) {
    ...
    for (unsigned int i = 0; i < points.size(); i++) {
      msg.points.push_back(
          createMessage<geometry_msgs::Point>(specs->elements[points[i]], i));
    }
  }
  return msg;
}
...
**/
template <>
stdr_msgs::LaserSensorMsg MessageCreator::createMessage(Node *n,
                                                        unsigned int id) {
  ...
  if (indexes.size() != 0) {
    msg.noise = createMessage<stdr_msgs::Noise>(specs->elements[indexes[0]], 0);
  }
...
**/
template <>
stdr_msgs::SonarSensorMsg MessageCreator::createMessage(Node *n,
                                                        unsigned int id) {
...
**/
template <>
stdr_msgs::RfidSensorMsg MessageCreator::createMessage(Node *n,
                                                       unsigned int id) {
...
**/
template <>
stdr_msgs::CO2SensorMsg MessageCreator::createMessage(Node *n,
                                                      unsigned int id) {
...
**/
template <>
stdr_msgs::ThermalSensorMsg MessageCreator::createMessage(Node *n,
                                                          unsigned int id) {
...
**/
template <>
stdr_msgs::SoundSensorMsg MessageCreator::createMessage(Node *n,
                                                        unsigned int id) {
...
**/
template <>
stdr_msgs::KinematicMsg MessageCreator::createMessage(Node *n,
                                                      unsigned int id) {
  ...
  if (indexes.size() == 0) {
    ...
    msg.type = specs->elements[indexes[0]]->elements[0]->value.c_str();
  }
...
stdr_msgs::RobotMsg MessageCreator::createMessage(Node *n, unsigned int id) {
  ...
  if (indexes.size() != 0) {
    for (unsigned int i = 0; i < indexes.size(); i++) {
      msg.laserSensors.push_back(createMessage<stdr_msgs::LaserSensorMsg>(
  ...
  if (indexes.size() != 0) {
    for (unsigned int i = 0; i < indexes.size(); i++) {
      msg.sonarSensors.push_back(createMessage<stdr_msgs::SonarSensorMsg>(
          specs->elements[indexes[i]], i));
    }
  }
  ...
  if (indexes.size() != 0) {
    for (unsigned int i = 0; i < indexes.size(); i++) {
      msg.rfidSensors.push_back(createMessage<stdr_msgs::RfidSensorMsg>(
          specs->elements[indexes[i]], i));
    }
  }
  ...
  if (indexes.size() != 0) {
    for (unsigned int i = 0; i < indexes.size(); i++) {
      msg.co2Sensors.push_back(createMessage<stdr_msgs::CO2SensorMsg>(
          specs->elements[indexes[i]], i));
    }
  }
  ...
  if (indexes.size() != 0) {
    for (unsigned int i = 0; i < indexes.size(); i++) {
      msg.thermalSensors.push_back(createMessage<stdr_msgs::ThermalSensorMsg>(
          specs->elements[indexes[i]], i));
    }
  }
  ...
  if (indexes.size() != 0) {
    for (unsigned int i = 0; i < indexes.size(); i++) {
      msg.soundSensors.push_back(createMessage<stdr_msgs::SoundSensorMsg>(
          specs->elements[indexes[i]], i));
    }
  }
  ...
  if (indexes.size() != 0) {
    msg.kinematicModel =
        createMessage<stdr_msgs::KinematicMsg>(specs->elements[indexes[0]], 0);
  }
